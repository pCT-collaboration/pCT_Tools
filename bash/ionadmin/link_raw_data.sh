...
Unless otherwise specified using execution parameters, this script assumes it is being executed from the directory containing the raw data and that it is experimental.  
